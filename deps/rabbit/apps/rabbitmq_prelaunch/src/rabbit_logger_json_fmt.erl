...
convert_to_types_accepted_by_jsx(Term) when is_pid(Term) ->
    String = pid_to_list(Term),
    unicode:characters_to_binary(String);
convert_to_types_accepted_by_jsx(Term) when is_atom(Term) ->
    String = atom_to_list(Term),
    unicode:characters_to_binary(String);
...
convert_to_types_accepted_by_jsx(Term) when is_map(Term) ->
    convert_to_types_accepted_by_jsx(lists:sort(maps:to_list(Term)));
